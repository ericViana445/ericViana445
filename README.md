<!--
**ericViana445/ericViana445** is a ✨ _special_ ✨ repository because its `README.md` appears on your GitHub profile.
-->

### Olá, eu sou Éric Viana 👋

Sou **Desenvolvedor Web Full-Stack**, entusiasta por criar automações, aplicações eficientes, interfaces intuitivas e estudante de **Licenciatura em Computação (UEA)**.

- 🔭 Atualmente trabalhando em projetos **desenvolvimento web, JavaScript, React** e **Node.js**.
